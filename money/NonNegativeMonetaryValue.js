...
const nonNegativeMonetaryValueExamples = monetaryValueExamples.filter(mv => mv.amount >= 0)
...
const NonNegativeMonetaryValue = addExamples(MonetaryValue.append({ amount }), nonNegativeMonetaryValueExamples)

module.exports = { nonNegativeMonetaryValueExamples, NonNegativeMonetaryValue }
