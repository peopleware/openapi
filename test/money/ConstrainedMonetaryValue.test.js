...
describe(testName(module), function () {
  describe('MonetaryValueEUR2', function () {
    shouldBeSeriousSchema(MonetaryValueEUR2, [
      {
  ...
  describe('ZeroMonetaryValueEUR2', function () {
    shouldBeSeriousSchema(ZeroMonetaryValueEUR2, [
      {
  ...
  describe('NonNegativeMonetaryValueEUR2', function () {
    shouldBeSeriousSchema(NonNegativeMonetaryValueEUR2, [
      {
  ...
  describe('PositiveMonetaryValueEUR2', function () {
    shouldBeSeriousSchema(PositiveMonetaryValueEUR2, [
      {
  ...
  describe('PositiveMonetaryValueEUR4', function () {
    shouldBeSeriousSchema(PositiveMonetaryValueEUR4, [
      {
  ...
  describe('NegativeMonetaryValueEUR2', function () {
    shouldBeSeriousSchema(NegativeMonetaryValueEUR2, [
      {
