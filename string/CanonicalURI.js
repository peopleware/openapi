...
const CanonicalURI = Joi.string().uri({ relativeOnly: true }).min(1)
  .description(`A _canonical URI_ is the URI where are resource can be interacted with, without the scheme and
authority (see
