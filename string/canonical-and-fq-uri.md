...
A resource of type `Y` has _canonical URI_ `/my-service/v1/y/abc`.

- service name: `my-service`
- relative URI of the resource in the API of the service: `/v1/y/abc` for the specific instance of `Y`
